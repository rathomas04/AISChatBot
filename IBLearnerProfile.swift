struct QuestionAnswerer {
    func responseTo(question: String) -> String {
        ...
        if lowerQuestion.contains("how") && lowerQuestion.contains("ib program") && lowerQuestion.contains("different") && lowerQuestion.contains("other programs") || lowerQuestion.contains("why") && lowerQuestion.contains("take") && lowerQuestion.contains("computer science") || lowerQuestion.contains("why") && lowerQuestion.contains("choose") && lowerQuestion.contains("computer science") {
